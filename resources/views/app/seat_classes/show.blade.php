...
<div class="container">
    <div class="card">
        <div class="card-body">
            ...
            <div class="mt-4">
                <div class="mb-4">
                    <h5>@lang('crud.seat_classes.inputs.seat_plan_id')</h5>
                    <span>{{ $seatClass->seat_plan_id ?? '-' }}</span>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    <h5>@lang('crud.seat_classes.inputs.seat_color')</h5>
                    <span>{{ $seatClass->seat_color ?? '-' }}</span>
                </div>
            </div>
