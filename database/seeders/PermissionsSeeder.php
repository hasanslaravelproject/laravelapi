...
class PermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        Permission::create(['name' => 'list seatplans']);
        Permission::create(['name' => 'view seatplans']);
        Permission::create(['name' => 'create seatplans']);
        Permission::create(['name' => 'update seatplans']);
        Permission::create(['name' => 'delete seatplans']);
